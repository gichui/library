...
<body bgcolor="pink">
	...
	<table align="center" bgcolor="yellow">
		<tr>
			...
			<td>
				<button>
					<a href="regestera.php"  target="_self">register new members</a>
			...
			<td>
				<button >
					<a href="loana.php"> loan out books</a>
				</button>
			...
			<td>
				<button>
					<a href="returna.php"> return books</a>
			...
			<td>
				<button>
					<a href="stokea.php"> VIEW THE STOCK</a>
				</button>
			...
			<td>
				<button>
					<a href="loan_viewa.php"> view loans</a>
			...
			<td width="7%">
				<button>
					<a href="defualtora.php"> check defualteor</a>
				</button>
